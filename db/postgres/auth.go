...
func (s *Postgres) ConsumeToken(token, action string) (string, error) {
	...
	const sqlDelete = `DELETE FROM magic_token WHERE token = $1;` // 1
...
func (s *Postgres) PurgeExpiredTokens() error {
