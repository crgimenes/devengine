...
func seedPersonEntity(t *testing.T, s *db.SQLite) (entityID, nameAttrID int64) {
	t.Helper()
...
func seedPersonRecord(t *testing.T, s *db.SQLite, entityID, attrID int64, name string) string {
	t.Helper()
...
func seedPerson(t *testing.T, s *db.SQLite, name string) string {
	t.Helper()
